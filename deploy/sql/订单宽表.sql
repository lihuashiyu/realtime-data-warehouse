select data['id']                    order_detail_id,
       ...
       pt
from topic_db
where `database` = 'gmall-211027-flink' and `table` = 'order_detail' and type = 'insert';
...
select data['id']                     id,
       ...
       old
from topic_db
where `database` = 'gmall-211027-flink' and `table` = 'order_info' and (type = 'insert' or type = 'update');
...
select data['id']               id,
       ...
       data['create_time']      create_time
	from topic_db
where `database` = 'gmall-211027-flink' and `table` = 'order_detail_activity' and type = 'insert';
...
select data['id']              id,
       ...
       data['create_time']     create_time
from topic_db
where `database` = 'gmall-211027-flink' and `table` = 'order_detail_coupon' and type = 'insert';
