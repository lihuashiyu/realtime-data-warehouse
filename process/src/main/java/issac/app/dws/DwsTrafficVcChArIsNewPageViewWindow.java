...
import issac.bean.TrafficPageViewBean;
...
public class DwsTrafficVcChArIsNewPageViewWindow
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStreamSource<String> uvDS = env.addSource(IssacKafkaUtil.getFlinkKafkaConsumer(uvTopic, groupId));
        DataStreamSource<String> ujDS = env.addSource(IssacKafkaUtil.getFlinkKafkaConsumer(ujdTopic, groupId));
        DataStreamSource<String> pageDS = env.addSource(IssacKafkaUtil.getFlinkKafkaConsumer(topic, groupId));
        ...
        resultDS.print(">>>>>>>>");
        resultDS.addSink(IssacClickHouseUtil.getSinkFunction("insert into dws_traffic_vc_ch_ar_is_new_page_view_window values(?,?,?,?,?,?,?,?,?,?,?,?)"));
